			...
			<?php foreach($this->usuario->Select() as $value) { 	
				...
				?>
					...
					<tr>
						...
						<td> <button type="button" class="btn btn-warning ToggleOpti" id="edit"   data-toggle="modal" data-target="#modaledit" value="<?php echo $conjunto; ?>"> Editar </button> </td>
						<td> <button type="button" class="btn btn-danger ToggleOpti"  id="delete" value="<?php echo $value->usu_id; ?>">Eliminar </button> </td>
					</tr>
