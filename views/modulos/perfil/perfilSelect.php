...
<div class="form-group">
  <label class="col-sm-2 col-sm-2 control-label"><i class="fa fa-envelope"></i> </label>
  <div class="col-sm-10">
    3175232591
  ...
  <p><button class="btn btn-theme"><i class="fa fa-envelope"></i> Send Message</button></p>
                      ...
                      <div class="col-md-6 detailed">
                        ...
                        <div class="row centered mb">
                          <ul class="my-friends">
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="img/friends/fr-01.jpg"> <h2>1907036</h2></div>
                              
                            </li>
                          </ul>
                          <ul class="my-friends">
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="img/friends/fr-01.jpg"> <h2>1235486</h2></div>
                            </li>
                          </ul>
                          <ul class="my-friends">
                            <li>
