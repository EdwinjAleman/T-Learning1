function Crear(){
    ...
    ajax.send("Ctr=material&Acc=insertar&titulo="+titulo+"&fecpub="+fecpub+"&descrp="+descrp+"&fasid="+fasid+"&usuid="+usuid+"&archurl="+archurl);
...
function CrearMaterial()
	...
	var usuid=document.formmaterial.usuid.value;
		...
		var destino ="main.php?Ctr=material&Acc=insertar&titulo="+titulo+"&fecpub="+fecpub+"&descrp="+descrp+"&fasid="+fasid+"&usuid="+usuid;
...
function BorrarArchivo(id,archurl)
	...
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("Ctr=material&Acc=eliminar&id="+id+"&file="+archurl);
	};
	}
