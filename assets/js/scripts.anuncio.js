	...
	function UpdateAnuncio()
	{
		...
		ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		ajax.send("ctrl=anuncio&acti=actualizar&anu_titulo="+titulo+"&anu_descripcion="+mensaje+"&anu_fechaCreacion="+fchcre+"&anu_fechaFin="+fchfin+"&anu_nombreCreador="+nombre);
